...
class tbsNavBar
{
    ...
    public function OnCommand($BlockLst, $Options, $PageCurr, $RecCnt=-1, $PageSize=1)
    {
    ...
    public function meth_Merge_NavigationBar(&$Txt, $BlockName, $Options, $PageCurr, $RecCnt, $PageSize)
    {
        $TBS =& $this->TBS;

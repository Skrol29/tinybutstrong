...
class clsTbsPlugInHtml
{
    ...
    public function OnOperation($FieldName, &$Value, &$PrmLst, &$Source, $PosBeg, $PosEnd, &$Loc)
    {
        if ($PrmLst['ope']!=='html') {
            return;
        }
    ...
    public function f_Html_InsertAttribute(&$Txt, &$Attr, $Pos)
    {
    ...
    public function f_Html_MergeItems(&$Txt, $ValueLst, $PrmLst, $PosBeg, $PosEnd)
    {
    ...
    public function f_Html_IsHtml(&$Txt)
    {

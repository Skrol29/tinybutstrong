...
class tbsByPage
{
    ...
    public function OnCommand($PageSize, $PageNum=0, $RecKnown=0)
    {
    ...
    public function BeforeMergeBlock(&$TplSource, &$BlockBeg, &$BlockEnd, $PrmLst, &$Src)
    {
        if ($this->PageSize<=0) {
            return;
    ...
    public function AfterMergeBlock(&$Buffer, &$Src)
    {
        if (!isset($Src->ByPage)) {
            return;
        }

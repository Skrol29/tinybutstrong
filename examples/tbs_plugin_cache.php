...
{
    public function OnInstall($CacheDir=false, $CacheMask=false)
    {
        $this->Version = '1.0.6';
    ...
    public function OnCommand($CacheId, $Action=3600, $Dir=false)
    {
        $TBS =& $this->TBS;
    ...
    public function BeforeShow(&$Render)
    {
    ...
    public function AfterShow(&$Render)
    {
    ...
    public function meth_Cache_Save($CacheFile, &$Txt)
    {

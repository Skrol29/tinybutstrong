...
class QuoteTestCase extends TBSUnitTestCase {
	...
	function testEmptyValue() {
		...
		$this->assertEqualMergeFieldStrings("<b>[onshow;when [a]='';block=b]</b>", array('a'=>''),  "<b></b>", "test empty #2 (empty string)", TBS_TEST_NEVERFIXEDBUG);
		...
		$this->assertEqualMergeFieldStrings("<b>[onshow;when [a]='';block=b]</b>", array('a'=>null),  "<b></b>", "test empty #6 (null value)", TBS_TEST_NEVERFIXEDBUG);
		...
		$this->assertEqualMergeFieldStrings("<b>[onshow;when [a]='';block=b]</b>", array('a'=>false),  "<b></b>", "test empty #10 (false value)", TBS_TEST_NEVERFIXEDBUG);
	...
	function testBugs() {
		...
		$this->assertEqualMergeFieldStrings("<b>[onshow;when [a]=';';block=b]</b>", array('a'=>';'),  "<b></b>", "test bug #2", TBS_TEST_NEVERFIXEDBUG);
		...
		$this->assertEqualMergeFieldStrings("<b>[onshow;when [a;htmlconv=esc]!='''';block=b]</b>", array('a'=>'\''),  "", "test bug #5", TBS_TEST_NEVERFIXEDBUG);
		$this->assertEqualMergeFieldStrings("<b>[onshow;when [a;htmlconv=esc]='''';block=b]</b>", array('a'=>'\''),  "<b></b>", "test bug #6", TBS_TEST_NEVERFIXEDBUG);
		...
		// vicious: with an ']' as value
		$this->assertEqualMergeFieldStrings("<b>[onshow;when [a]!=']';block=b]</b>", array('a'=>']'),  "", "test bug #9", TBS_TEST_NEVERFIXEDBUG);
		$this->assertEqualMergeFieldStrings("<b>[onshow;when [a]=']';block=b]</b>", array('a'=>']'),  "<b></b>", "test bug #10", TBS_TEST_NEVERFIXEDBUG);

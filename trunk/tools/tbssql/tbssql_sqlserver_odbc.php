...
// Database Engine: SQL-Server via Windows or Linux ODBC
// Version 1.04, 2010-10-21, Skrol29
	
	function _Dbs_Prepare() {
		$this->Version .= ' SQL-Server via ODBC (Windows or Linux)';
	}
	...
	function _Dbs_LastRowId($Info=false) {

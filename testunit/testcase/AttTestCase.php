...
class AttTestCase extends TBSUnitTestCase
{
    ...
    public function testMergeBlocks()
    {
        $blk = array();
    ...
    public function testMergeBlocksWithCachedFields()
    {
        $data = array();
    ...
    public function testMergeBlocksWithGroup()
    {
        if (!$this->atLeastTBSVersion('3.8')) {
            return;
        }
    ...
    public function testOnShowMagnet()
    {
    ...
    public function testBugs()
    {
        ...
        if ($this->atLeastTBSVersion('3.6.2-dev')) {
            $this->assertEqualMergeFieldStrings('<div Width="250px">[move;att=Width]hello</div>', array('move'=>'50%'), '<div Width="50%">hello</div>', "test bug #15");
        } // return '<div Width="250px" Width="50%">hello</div>' => the existing attribut is not found because the internal list of parameters is set to lowercase by TBS
    }
}

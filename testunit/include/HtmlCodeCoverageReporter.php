...
{
    public $code_coverage = '';
    public $code_coverage_include_paths = array();
    public $code_coverage_exclude_paths = array();
    public $time = 0;
     ...
     */
    public function HtmlCodeCoverageReporter($includePaths, $excludePaths = null)
    {
        $this->HtmlReporter();
    ...
    public function acceptCoverageFile($fileName)
    {
        $found = false;
    ...
    public function cleanDirecory($path)
    {
     ...
     */
    public function paintCodeCoverage()
    {
     ...
     */
    public function paintFileSource($fileName, $coverageData)
    {

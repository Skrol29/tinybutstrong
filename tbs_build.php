...
$Ok = $Ok && f_Replace($Txt, 'if ((PHP_VERSION===\'4.4.1\') and is_array($this->VarRef[$Item0])) {$Var = $this->VarRef[$Item0];} else {$Var = &$this->VarRef[$Item0];}', '$Var = &$this->VarRef[$Item0];', 'Delete bug 3 specific to PHP 4.4.1');
